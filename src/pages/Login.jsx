...
const Login = () => {
  ...
  return (
    <div className='relative w-full h-full p-10'>
      ...
      <div className='flex h-[90vh] bg-gray-200 md:flex-row flex-col my-5 md:my-3 h-full '>
        ...
        <div className='basis-2/3 flex justify-center items-center flex-col gap-5'> 
          <p className='text-bg-purpleDark text-3xl  py-3'>Login</p>

          <form className="flex flex-col gap-5 p-2  md:w-1/3 w-2/3" onSubmit={handleSubmit} >
            ...
            <div className="w-full flex justify-center py-3">
              <Button 
                type="submit"
                radius="full" 
                className="bg-primary text-white w-3/4"
              >
                Sign In
              </Button>
            </div>
          ...
          <div className="flex  flex-col py-5">
            <a href="#" className="text-danger py-3">Forgot Password</a>
